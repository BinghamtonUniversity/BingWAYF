...
<div class="row">
    ...
    @{{^selected_idp}}
    <div class="row">
        <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-12" style="margin-top:40px;">
            <div class="well" style="text-align:center;">
                <div style="margin-bottom:15px;">Please select one of the identity providers below:</div>
                @{{#enabled_idps}}
                    <div style="margin-bottom:15px;">
                        <div data-idpid="@{{id}}" class="btn btn-lg btn-primary idp-link" style="background-color:#005a43;border-color:#004131;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;width:100%;">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <a href="/idp/google/@{{#redirect}}?redirect=@{{redirect}}@{{/redirect}}" class="btn btn-lg btn-default" style="margin-bottom:15px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;width:100%">
                    ...
                    <div class="col-sm-6">
                        <a href="/idp/microsoft/@{{#redirect}}?redirect=@{{redirect}}@{{/redirect}}" class="btn btn-lg btn-default" style="margin-bottom:15px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;width:100%">
                            <img width="18px" height="18px" src="https://www.microsoft.com/favicon.ico">
